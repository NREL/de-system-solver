...
#are these the right values for rk23 and rk45, or are these rk45 specific and need to be different for rk23?
max_iter = 10
rtol = 1e-3
dt_init = 1e-3
...
#does this need to have a separate rk23 and rk45 version?
